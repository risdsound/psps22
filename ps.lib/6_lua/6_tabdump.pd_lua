-- pdlua example included with library, just renamed

local Tabdump = pd.Class:new():register("6_tabdump")

function Tabdump:initialize(sel, atoms)
  self.inlets = 1
  self.outlets = 2
...
function Tabdump:in_1_symbol(s)
  self.name = s
  self:in_1_bang()
end
